...
CREATE TABLE public.products (
    ...
    -- false = prices set manually; true = sync keeps net margin within 13-34% (src/lib/pricing.ts)
...
-- ----------------------------------------------------------------------------
-- GIVING REPORTS (3% of product subtotals to people in need in Iran)
-- ----------------------------------------------------------------------------
CREATE TABLE public.giving_reports (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
