...
export const SOCIAL_PRODUCT_COLUMNS =
  "id, slug, status, visibility, name_en, name_fa, product_type, price, sale_price, sale_starts_at, sale_ends_at, currency, featured_image_url, desc_emotional_en, desc_functional_en, desc_story_en, desc_story_fa, seo_keywords";
