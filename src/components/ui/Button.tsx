...
interface CustomButtonProps extends React.ComponentPropsWithoutRef<typeof ButtonPrimitive>, VariantProps<typeof buttonVariants> {
...
function Button({
  ...
  if (href) {
    return (
      <Link href={href} className={compClasses} {...(props as any)}>
        {content}
      </Link>
    );
  }
